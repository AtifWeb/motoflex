...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const id = url.split("/bike/")[1];
    getBikeById(id, setdata);
  }, []);
        ...
        <div className="bg-[#fff] p-6 rounded-[10px] mt-3">
          ...
          <div className="grid grid-cols-3 gap-2 mt-4">
            <p className="text-[17px]">
              <span className="font-bold">Engine Type:</span> {data?.petroltype}
            </p>
            <p className="text-[17px]">
              <span className="font-bold">Year Registerted:</span> {data?.year}
            </p>
            <p className="text-[17px]">
              <span className="font-bold">Km Driven:</span> {data?.driven}
            </p>
          </div>
        </div>
